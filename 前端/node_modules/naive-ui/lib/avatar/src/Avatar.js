...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        // Not Good Impl
        vue_1.onMounted(() => adjustText());
        vue_1.onUpdated(() => {
            adjustText();
        });
        const themeRef = _mixins_1.useTheme('Avatar', 'Avatar', index_cssr_1.default, styles_1.avatarLight, props, mergedClsPrefixRef);
        return {
            textRef,
            selfRef,
            ...
            cssVars: vue_1.computed(() => {
                ...
                if (typeof size === 'number') {
                    ...
                    height = themeRef.value.self[_utils_1.createKey('height', size)];
                }
                return {
                    '--font-size': fontSize,
    ...
    render() {
        ...
        return (vue_1.h("span", { ref: "selfRef", class: `${mergedClsPrefix}-avatar`, style: this.cssVars }, !$slots.default && src ? (vue_1.h("img", { src: src, onError: this.onError, style: { objectFit: this.objectFit } })) : (vue_1.h("span", { ref: "textRef", class: `${mergedClsPrefix}-avatar__text`, style: { background: this.color } }, $slots))));
    }
});

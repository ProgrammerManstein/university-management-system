...
exports.default = vue_1.defineComponent({
    ...
    render() {
        ...
        return (vue_1.h("div", { class: [
            ...
            ], style: this.cssVars, onMouseleave: this.handleMouseLeave }, vue_1.renderList(this.count, (_, index) => {
            const icon = defaultSlot ? (defaultSlot()) : (vue_1.h(_internal_1.NBaseIcon, { clsPrefix: mergedClsPrefix }, { default: () => StarIcon_1.default }));
            return (vue_1.h("div", { key: index, class: [
                ...
                icon,
                this.allowHalf ? (vue_1.h("div", { class: [
                        `${mergedClsPrefix}-rate__half`,
                        {
                            [`${mergedClsPrefix}-rate__half--active`]: hoverIndex !== null

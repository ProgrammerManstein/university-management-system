...
export default defineComponent({
    ...
    render() {
        ...
        return (h("span", { ref: "selfRef", class: `${mergedClsPrefix}-avatar`, style: this.cssVars }, !$slots.default && src ? (h("img", { src: src, onError: this.onError, style: { objectFit: this.objectFit } })) : (h("span", { ref: "textRef", class: `${mergedClsPrefix}-avatar__text`, style: { background: this.color } }, $slots))));
    }
});
